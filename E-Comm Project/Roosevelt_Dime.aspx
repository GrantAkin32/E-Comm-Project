<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Roosevelt_Dime.aspx.cs" Inherits="E_Comm_Project.Roosevelt_Dime" %>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <ul class="pagination justify-content-center" style="margin-top:12px;">
                      ...
                      <li class="page-item active"><a class="page-link" href="Roosevelt_Dime.aspx"><font color=black>1</font></a></li>
                      <li class="page-item"><a class="page-link" href="Roosevelt_Dime2.aspx"><font color=black>2</font></a></li>
                         <li class="page-item"><a class="page-link" href="Roosevelt_Dime3.aspx"><font color=black>2</font></a></li>
